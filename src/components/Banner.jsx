    ...
    return (
        <div className='mt-4'>
            <div style={{backgroundImage:"url('../src/assets/images/Rectangle 1.png')"}} className='text-white text-center flex flex-col rounded-3xl justify-center items-center bg-cover bg-no-repeat bg-center space-y-8 h-[500px]' >
                ...
                <p className="mx-20 px-16 text-lg ">Learn and Master Basic Programming, Data Structures, Algorithm, OOP, Database and solve 500+ coding problems to become an exceptionally well world-class Programmer.</p>
